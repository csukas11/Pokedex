...
extension UIViewController {
  ...
  func hideKeyboardWhenSwipedUp() {
    setSwipeGestureRecognizer(direction: .up)
  }
  
  func hideKeyboardWhenSwipedDown() {
    setSwipeGestureRecognizer(direction: .down)
  }

  private func setSwipeGestureRecognizer(direction: UISwipeGestureRecognizer.Direction) {
